...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Service.Domain.Auth", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Service.Domain.User", b =>
                {
                    b.HasOne("Service.Domain.Auth", "Auth")
                        .WithOne()
                        .HasForeignKey("Service.Domain.User", "AuthId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsOne("Service.Domain.Email", "Email", b1 =>
                        {
                    ...
                    b.OwnsOne("Service.Domain.Name", "Name", b1 =>
                        {
                            b1.Property<long>("UserId")
                                .HasColumnType("bigint");
